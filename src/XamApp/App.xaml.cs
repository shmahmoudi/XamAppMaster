...
namespace XamApp
{
    public partial class App : BitApplication
    {
        ...
        protected override async Task OnInitializedAsync()
        {
           ...
           // await NavigationService.NavigateAsync("/Nav/Notifiction"); // 
            await NavigationService.NavigateAsync("/Nav/Service");
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry, ContainerBuilder containerBuilder, IServiceCollection services)
        {
            ...
            containerRegistry.RegisterForNav<NotifictionView, NotifictionViewModel>("Notifiction");
            containerRegistry.RegisterForNav<ServiceView, ServiceViewModel>("Service");
